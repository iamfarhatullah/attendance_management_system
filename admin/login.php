			...
			<div class="col-md-4 col-md-offset-4">
				<div class="setup-box">
					...
					<form action="checkAdmin.php" method="post">
						...
						<input type="text" class="setup-input" name="admin_username" placeholder="Enter Username" autocomplete="off" required>
						<label>Password</label><br>
						<input type="password" id="input" class="setup-input" name="admin_password" placeholder="Enter Password" autocomplete="off" required>
